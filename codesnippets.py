...
CLASS_ARCHETYPE_NAME = """    # This name appears in the 'add' box
    archetype_name             = '%s'\n"""
CLASS_IMPLEMENTS     = """    interface.implements( %(baseclass_interfaces)s + (%(realizations)s,))"""
CLASS_IMPLEMENTS_BASE= """    interface.implements( %(baseclass_interfaces)s)"""
...
IMPORT_INTERFACE     = """from zope.interface import Interface"""
