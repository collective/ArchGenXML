...
models_typelist = {
   ...
   'file': {'func':'models.ImageField', 'required':['upload_to'], 'optional': ['height_field', 'width_field']},
...
the Member will not be inherited by child subclasses."""},
 ...
 'code': {'cats':['attribute'], 'desc':"""If there is no Code in or no existing function, tgc code will make you able to maintain simple code fragments direct in uml"""},
}

#please do not put 'null'  here
#this will be done in self.convertAssocToDjango
models_assoc_optionals_o = [
    'blank',
    'edit_inline',
 ]
models_assoc_optionals_m = [
    'blank',
#    'edit_inline',
 ]

models_assoc_optionals_from = [
     'edit_inine',
]
