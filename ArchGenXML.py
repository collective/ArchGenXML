...
#
# Created:     2003/16/04
# RCS-ID:      $Id: ArchGenXML.py,v 1.115 2004/04/03 15:22:47 zworkb Exp $
...
from Products.CMFCore.utils import UniqueObject
    ...
    def generateDependentImports(self,outfile,element):
        ...
        print >>outfile
        reparentnames = [p.getCleanName() for p in element.getRealizationParents()]
        for p in reparentnames:
            print >> outfile,'from %s import %s' % (p,p)
