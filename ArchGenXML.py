...
#
# Created:     2003/16/04
# RCS-ID:      $Id: ArchGenXML.py,v 1.76 2004/01/18 21:42:31 yenzenz Exp $
...
"""
    ...
    def generateModuleInfoHeader(self, outfile, modulename, element): 
        ...
        fileheaderinfo = {'filename': modulename+'.py',
                          'purpose':  element.getDocumentation() or 'unknown',
                          ...
                          'copyright':element.getTaggedValue('copyright', self.copyright) or 'unknown',
                          'licence':  element.getTaggedValue('licence', self.licence) or 'GNU General Public Licence (GPL) Version 2 or newer',
        }        
...
(c) 2003 BlueDynamics, under GNU General Public License 2.0 or later
"""
...
Options (defaults marked with '*'):
    ...
    --i18n-support                                      support for i18NArchetypes:
                                                            ...
                                                            are multilingual
    --no-module-info-header                                    do not generate info header
    --author=, --e-mail=, --copyright=, --licence=      set default strings for module info-headers
"""
