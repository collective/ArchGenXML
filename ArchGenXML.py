...
#
# Created:     2003/16/04
# RCS-ID:      $Id: ArchGenXML.py,v 1.102 2004/02/27 10:21:42 zworkb Exp $
...
from Products.CMFCore.utils import UniqueObject
    ...
    def generateClasses(self, outfile, element, delayed):
        ...
        if element.getTaggedValue('allowed_subtypes'):
            refs=refs+element.getTaggedValue('allowed_subtypes').split(',')
