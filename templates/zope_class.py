...
<dtml-let security_decl="generator.generateMethodSecurityDeclaration(m)">
<dtml-if "security_decl">
<dtml-var "security_decl">
</dtml-if>
</dtml-let>
...
<dtml-var "generator.getProtectedSection(parsed_class,'class-footer_'+klass.getCleanName(),1)">
InitializeClass(<dtml-var "klass.getCleanName()">)
